...
// as `[max_seq, head_dim/2, 2]` FP32 (cos, sin pairs).
...
struct Params {
  ...
  data_offset: u32,        // f32 offset of [n_tokens, n_heads, head_dim]
  rope_table_offset: u32,  // f32 offset; per pos: head_dim/2 (cos,sin) pairs = head_dim floats
  _p0: u32, _p1: u32,
};

@group(0) @binding(0) var<uniform> p: Params;
@group(0) @binding(1) var<storage, read> rope_cs: array<f32>;
